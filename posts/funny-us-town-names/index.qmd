...
A dummy intro to what is going to happen.
...
Let's read from the link <https://www.farandwide.com/s/wacky-town-names-47d4c1c59a624a70>

```{r}
link <- "https://www.farandwide.com/s/wacky-town-names-47d4c1c59a624a70"
```

I will run the following command from the terminal to start the Docker container which will act like a server `docker run -d -p 4445:4444 selenium/standalone-firefox`
...
Since, the article says 65 town names let's peek at the values from 61-70 and decide where to cut-off.
